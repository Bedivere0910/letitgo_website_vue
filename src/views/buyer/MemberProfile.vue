  ...
  <main class="container" style="margin-top: 20px">
    <div class="content-row">
      <div class="col photo-column">
        <div :class="state === 'edit' ? 'photo-container' : 'photo-container2'" @click="triggerFileUpload">
          <img :src="previewImage !== 'edit'
            ? previewImage
            : `${API_URL}/member/photo/${id}`
          " class="photo w-100" />
          <i v-if="this.state === 'edit'" class="photo-edit-icon fas fa-upload"></i>
          <input type="file" accept=".jpg, .png" class="d-none" ref="memberPhoto" @change="previewPhoto" />
        </div>
      </div>
          ...
          <div class="col-md-8">
            <div class="row mt-3">
              ...
              <div class="col">
                ...
                <input v-else type="text" v-model="member.memberName" class="form-control" />
              </div>
            </div>
            <div class="row mt-3">
            ...
            <div class="row mt-3">
              ...
              <div class="col">
                ...
                <input v-else type="tel" v-model="member.memberPhone" class="form-control" />
              </div>
            </div>
            <div class="row mt-3">
              ...
              <div class="col">
                ...
                <input v-else type="text" v-model="member.memberAddress" class="form-control" />
              </div>
            </div>
            <div class="row mt-3">
              ...
              <div class="col">
                ...
                <input v-else type="date" v-model="member.birthDate" class="form-control" />
              </div>
            </div>
            <div class="row mt-3">
              ...
              <div class="col">
                ...
                <div v-else class="gender-container">
                  <label class="gender-radio text-display">
                    <input type="radio" name="gender" value="male" v-model="member.memberGender" />
                    <span class="gender-label">男性</span>
                  </label>
                  <label class="gender-radio text-display">
                    <input type="radio" name="gender" value="female" v-model="member.memberGender" />
                    <span class="gender-label">女性</span>
                  </label>
                  <label class="gender-radio text-display">
                    <input type="radio" name="gender" value="other" v-model="member.memberGender" />
    ...
    <div class="edit-controls">
      <button v-if="this.state === 'normal'" @click="switchToEditPage"
        class="edit-button bi bi-pencil-fill text-success"></button>
      <button v-if="this.state === 'edit'" @click="cancelToEdit"
        class="cancel-button bi bi-x-square text-danger"></button>
      <button v-if="this.state === 'edit'" @click="sendToEdit"
        class="send-button bi bi-check-square text-primary"></button>
    </div>
  </main>
</template>
