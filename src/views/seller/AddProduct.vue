<template>
  <main class="container">
    ...
    <div class="mb-3">
      ...
      <input type="text" id="productName" class="form-control" placeholder="請輸入商品名稱" name="productName" required
        v-model="productName" />
    </div>

    <div class="mb-3">
      <label for="productPhoto" class="form-label"><b>商品頁面圖片:</b></label>
      <input type="file" accept=".jpg,.png" id="productPhoto" class="form-control" name="productPhoto"
        ref="productPhoto" />
    </div>
    ...
    <div class="mb-3">
      ...
      <div v-for="(ps, index) in productSpec" :key="index" class="row g-2 mt-2">
        <div class="col">
          <input type="text" class="form-control" placeholder="請輸入商品規格" name="productSpecName" required
            v-model="productSpec[index].productSpecName" />
        </div>
        <div class="col">
          <input type="number" class="form-control" placeholder="請輸入商品庫存" name="stockQuantity" required
            v-model="productSpec[index].stockQuantity" />
        </div>
        <div class="col">
          <input type="number" class="form-control" placeholder="請輸入商品售價" name="productSellingPrice" required
            v-model="productSpec[index].productSellingPrice" />
        </div>
        <div class="col">
          <input type="number" class="form-control" placeholder="請輸入商品建議售價" name="productOriginPrice" required
    ...
    <div class="mb-3">
      <input type="reset" class="btn btn-secondary me-2" value="清除" @click="cancelToAddProduct" />
